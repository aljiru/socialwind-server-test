 ...
 *******************************************************************************/
package org.inftel.socialwind.client;
...
import org.inftel.socialwind.client.MyRequestFactory.HelloWorldRequest;
import org.inftel.socialwind.client.MyRequestFactory.MessageRequest;
import org.inftel.socialwind.shared.MessageProxy;

public class SocialwindWidget extends Composite {
  ...
  interface SocialwindUiBinder extends UiBinder<Widget, SocialwindWidget> {
  }

  private static SocialwindUiBinder uiBinder = GWT.create(SocialwindUiBinder.class);
